...
export default function GoogleButton({ onClick, text }: GoogleButtonProps) {
  return (
    <button
      onClick={onClick}
      className="w-full max-w-[280px] flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-[#4285F4] rounded-full hover:bg-gray-50 transition-colors"
    >
